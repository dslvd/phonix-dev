...
export default function Profile({ navigate, openMobileNav, appState, updateState, premium }: ProfileProps) {
  ...
  const isGuestMode =
    !!userData &&
    ((userData.name || "").trim().toLowerCase() === "guest" ||
      ...
      <div className="mx-auto mt-6 max-w-6xl">
          ...
          >
            ...
            {userData ? (
              <div className="mt-4 space-y-4">
                ...
                <div>
                  <label className="theme-text-soft mb-2 block text-sm font-bold">Name</label>
                  {isEditing ? (
                    <div className="flex gap-2">
                      <input
                        ...
                        className="theme-bg-surface flex-1 rounded-xl border px-4 py-2 font-baloo outline-none focus:border-[#56b8e8]"
                      />
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                      ...
                      <motion.button
                        ...
                        className="theme-bg-surface rounded-xl border px-4 py-2 font-bold"
                      >
                        ✕
                      </motion.button>
                    </div>
                  ) : (
                    <div className="theme-bg-surface flex items-center justify-between rounded-xl border px-4 py-3">
                ...
                <div>
                  <label className="theme-text-soft mb-2 block text-sm font-bold">Email</label>
                  <div className="theme-bg-surface rounded-xl border px-4 py-3">
                    <p className="theme-text-soft font-semibold">{userData.email}</p>
                  </div>
                </div>
              </div>
            ) : (
              <div className="theme-text-soft py-8 text-center">
          ...
          >
            ...
            <div className="mt-3 space-y-2.5">
              ...
              <div className="theme-bg-surface rounded-xl border p-3">
                ...
                <p className="mt-1 font-baloo text-2xl font-bold capitalize">
          ...
          >
            ...
            >
              <div className="text-center">
                ...
                <h3 className="font-baloo text-3xl font-bold">Unlock Unlimited Batteries!</h3>
        ...
        >
          <motion.button
            ...
            className="theme-bg-surface rounded-xl border px-8 py-3 font-bold uppercase tracking-[0.08em] transition"
          >
