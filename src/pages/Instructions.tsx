    ...
    <div className="min-h-screen px-4 py-5 lg:px-6">
      ...
      <div className="mx-auto mt-6 max-w-6xl">
        ...
        <motion.div
          ...
          className="theme-bg-surface rounded-2xl border-b-4 px-5 py-4"
        >
          ...
          <p className="theme-text-soft mt-2 text-sm font-semibold">
            Language: {appState.nativeLanguage || "English"} {"->"}{" "}
        ...
        <motion.div
          ...
          className="theme-bg-surface mt-5 rounded-2xl border p-5"
        >
          ...
          <ul className="theme-text-soft mt-3 space-y-2 text-sm font-semibold">
            <li>
              Guest mode is interactive: dashboard, lessons, map progression, and browsing features.
            </li>
            <li>
              Logged-in mode enables cloud progress sync, leaderboard ranking, and full account
              tracking.
            </li>
            <li>
              If you want permanent progress history and ranking, create an account from the landing
              page.
            </li>
          </ul>
        </motion.div>
