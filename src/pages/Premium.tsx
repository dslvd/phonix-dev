      ...
      <div className="max-w-6xl mx-auto p-4 mt-6">
        ...
        >
          ...
          {localError && (
            <motion.div
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-6 bg-red-900/40 border-2 border-red-400/50 rounded-xl p-4 inline-block"
            >
              <p className="text-red-300 font-bold">{localError}</p>
            </motion.div>
          )}
            ...
            <Card className="bg-gradient-to-br from-yellow-400 via-pink-400 to-purple-500 border-4 border-yellow-300 shadow-2xl">
              <div className="text-center p-8">
                ...
                <motion.button
                  ...
                  disabled={loading}
                  className="bg-white text-purple-600 px-12 py-4 rounded-2xl font-bold text-xl shadow-2xl hover:bg-yellow-50 transition-colors disabled:opacity-60"
                >
                  <span className="flex items-center gap-3">
                    <span>💖</span>
                    {loading ? 'Processing…' : 'Unlock Unlimited Hearts'}
                    <span>💖</span>
                  </span>
                </motion.button>
              </div>
        ...
        >
          <motion.button
            ...
            onClick={handleUnlockPremium}
            disabled={loading}
            className="bg-gradient-to-r from-yellow-400 via-pink-400 to-purple-500 text-white px-16 py-6 rounded-3xl font-bold text-2xl shadow-2xl hover:shadow-yellow-500/50 transition-all disabled:opacity-60"
          >
            <span className="flex items-center gap-3">
              <span className="text-3xl leading-none flex items-center justify-center">🚀</span>
              {loading ? 'Processing…' : 'Start Your Magic Journey'}
              <span className="text-3xl leading-none flex items-center justify-center">✨</span>
            </span>
          </motion.button>
